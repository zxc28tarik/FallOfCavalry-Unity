...
namespace FOC.Tests
{
    public sealed class CharacterSaveTests
    {
        ...
        public void SchemaOneFixture_MigratesDeterministicallyToSchemaTwoWithoutInventedCharacters()
        {
            ...
            Assert.That(read.Success, Is.True, read.Error);
            var pipeline = new SaveMigrationPipeline(new ISaveMigration[] { new CampaignSaveV1ToV2Migration(), new CampaignSaveV2ToV3Migration(), new CampaignSaveV3ToV4Migration(), new CampaignSaveV4ToV5Migration(), new CampaignSaveV5ToV6Migration(), new CampaignSaveV6ToV7Migration(), new CampaignSaveV7ToV8Migration(), new CampaignSaveV8ToV9Migration() });
            ...
            Assert.That(first.Data!.SaveVersion, Is.EqualTo(9));
