...
namespace FOC.Tests
{
    public sealed class CliqueTests
    {
        ...
        [Test] public void Clique_CannotOwnGoodsSoldiersOrArmy() { var clique = Clique("a"); Assert.Multiple(() => { Assert.That(clique.CanOwnGoods, Is.False); Assert.That(clique.CanOwnSoldiers, Is.False); Assert.That(clique.CanOwnArmy, Is.False); }); }
